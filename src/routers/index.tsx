...
import ListingTourPage from "containers/pageTour/ListingTourPage";
import ListingTourMapPage from "containers/pageTour/ListingTourMapPage";
...
import ListingTransportPage from "containers/pageTransport/ListingTransportPage";
import ListingTransportMapPage from "containers/pageTransport/ListingTransportMapPage";
import ListingFilmPage from "containers/PageFilm/ListingFilmPage";
import ListingFilmMapPage from "containers/PageFilm/ListingFilmMapPage";
import ListingDavosPage from "containers/PageDavos/ListingDavosPage";
import ListingDavosMapPage from "containers/PageDavos/ListingDavosMapPage";
...
import ManageAddress from "containers/AccountPage/ManageAddress";
...
export const pages: Page[] = [
  ...
  //
  { path: "/transportation", component: ListingTransportPage },
  { path: "/transportation-map", component: ListingTransportMapPage },
  //
  { path: "/tour", component: ListingTourPage },
  { path: "/tour-map", component: ListingTourMapPage },
  //
  { path: "/davos", component: ListingDavosPage },
  { path: "/davos-map", component: ListingDavosMapPage },
  //
  { path: "/film", component: ListingFilmPage },
  { path: "/film-map", component: ListingFilmMapPage },
];
...
const MyRoutes = () => {
  ...
  return (
    <BrowserRouter
      basename={process.env.NODE_ENV === "production" ? "ETT" : ""}
    >
      <ScrollToTop />
      <SiteHeader />
